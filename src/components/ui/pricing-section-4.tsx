...
const plans = [
  {
    name: "Free",
    description:
      "Get started with AI-powered chatbots. No credit card required.",
    price: 0,
    yearlyPrice: 0,
  ...
  },
  {
    name: "Pro",
    description:
      "Best value for growing businesses that need more power and flexibility.",
    price: 20,
    yearlyPrice: 199,
  ...
  },
  {
    name: "Max",
    description:
      "Unlimited power, full customization, and white-label for large teams.",
    price: 45,
    yearlyPrice: 449,
    buttonText: "Get started",
    buttonVariant: "outline" as const,
      ...
      <div className="relative z-10 mx-auto flex w-fit rounded-full bg-neutral-900 border border-gray-700 p-1">
        ...
        >
          ...
          <span className="relative flex items-center gap-2">
            Yearly
            <span className="text-xs bg-green-500/20 text-green-400 px-1.5 py-0.5 rounded-full font-normal">
              Save 17%
            </span>
          </span>
        </button>
            ...
            >
              {plan.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                  <span className="bg-gradient-to-r from-blue-500 to-blue-600 text-white text-xs font-semibold px-3 py-1 rounded-full border border-blue-400">
                    Most Popular
                  </span>
                </div>
              )}
              ...
              <CardContent className="pt-0">
                <a
                  ...
                  className={`block w-full mb-6 p-4 text-xl rounded-xl text-center transition-all hover:scale-[1.03] active:scale-[0.97] ${
                    plan.popular
